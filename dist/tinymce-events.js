(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'jquery', 'koco-url-utilities', 'tinymce', 'rangy'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('jquery'), require('koco-url-utilities'), require('tinymce'), require('rangy'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jquery, global.kocoUrlUtilities, global.tinymce, global.rangy);
        global.tinymceEvents = mod.exports;
    }
})(this, function (exports, _jquery, _kocoUrlUtilities, _tinymce, _rangy) {
    'use strict';
