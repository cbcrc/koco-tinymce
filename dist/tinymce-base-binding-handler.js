(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'knockout', 'jquery', 'koco-url-utilities', 'tinymce-events', 'tinymce-utilities', 'tinymce'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('knockout'), require('jquery'), require('koco-url-utilities'), require('tinymce-events'), require('tinymce-utilities'), require('tinymce'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.knockout, global.jquery, global.kocoUrlUtilities, global.tinymceEvents, global.tinymceUtilities, global.tinymce);
        global.tinymceBaseBindingHandler = mod.exports;
    }
})(this, function (exports, _knockout, _jquery, _kocoUrlUtilities, _tinymceEvents, _tinymceUtilities, _tinymce) {
    'use strict';
