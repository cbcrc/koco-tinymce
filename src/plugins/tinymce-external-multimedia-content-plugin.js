...
define([
    ...
    function($, urls, mceDialogFactory) {
        ...
        function fromDialogResultToMarkup(dialogResult) {
            //youTube
            if (dialogResult.contentType.id === 3) { return generateYouTubeFigure(dialogResult);}
            //SoundCloud
            if (dialogResult.contentType.id === 4) { return generateSoundCloudFigure(dialogResult); }
            //Vine
            if (dialogResult.contentType.id === 5) { return generateVineFigure(dialogResult); }
            //Instagram
            if (dialogResult.contentType.id === 6) { return generateInstagramFigure(dialogResult); }
            //Vimeo
            if (dialogResult.contentType.id === 7) { return generateVimeoFigure(dialogResult); }
