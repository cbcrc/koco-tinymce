...
define(['jquery'],
    function($) {
        ...
        return {
            ...
            notManagedButtons: ['code', 'visualchars', 'visualblocks', 'pastetext', 'shortcuts'],
            zones: [{
                name: 'bullist',
                ...
                name: 'externalMultimediaContent',
                enabledButtons: ['externalMultimediaContent'],
                activeButtons: ['externalMultimediaContent'],
                inZoneSelector: 'figure.embed'
            }, {
                name: 'htmlSnippet',
                enabledButtons: ['htmlSnippet'],
                activeButtons: ['htmlSnippet'],
                inZoneSelector: 'figure.snippet'
            }, {
                name: 'medianet',
                enabledButtons: ['medianet'],
                activeButtons: ['medianet'],
                inZoneSelector: 'figure.medianet'
            }, {
                name: 'images',
                enabledButtons: ['images'],
                activeButtons: ['images'],
                inZoneSelector: 'figure.image'
            }, {
                name: 'photoAlbum',
                enabledButtons: ['photoAlbum'],
                activeButtons: ['photoAlbum'],
                inZoneSelector: 'figure.gallery'
            }, {
                name: 'framed',
                ...
                enabledButtons: [
                    ...
                    'bullist', 'numlist', 'nonbreaking', 'br', 'hr', 'externalMultimediaContent', 'medianet', 'images', 'imageAlbum', 'htmlSnippet'
                ],
            ...
            shortcuts: {
                ...
                numlist: ['ctrl+shift+7', 'numlist_desc', 'InsertOrderedList'],
                bullist: ['ctrl+shift+8', 'bullist_desc', 'InsertUnorderedList']
            },
